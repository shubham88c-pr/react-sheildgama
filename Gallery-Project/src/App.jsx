...
const App = () => {
  ...
  const getData = async()=>{
    ...
    // axios.post('https://picsum.photos/v2/list?page=2&limit=100',{username:'sarthak',password:'sarthak'})
    
    // const response = await axios.get('https://picsum.photos/v2/list?page=2&limit=100')
    // const response = await axios.get('https://picsum.photos/v2/list?page=5&limit=15')
